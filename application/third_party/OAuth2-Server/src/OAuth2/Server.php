    ...
    UserInfoControllerInterface
{
    ...
    protected $responseTypeMap = array(
        'Token_lib' => 'OAuth2\ResponseType\AccessTokenInterface',
    ...
    protected function getDefaultResponseTypes()
    {
        ...
        if ($this->config['allow_implicit']) {
            $responseTypes['Token_lib'] = $this->getAccessTokenResponseType();
        }
    ...
    {
        if (isset($this->responseTypes['Token_lib'])) {
            return $this->responseTypes['Token_lib'];
        }
